...
def load():
    ...
    try:
        SOUNDS['die']    = pygame.mixer.Sound(current_dir + '/../assets/audio/die' + soundExt)
        SOUNDS['hit']    = pygame.mixer.Sound(current_dir + '/../assets/audio/hit' + soundExt)
        SOUNDS['point']  = pygame.mixer.Sound(current_dir + '/../assets/audio/point' + soundExt)
        SOUNDS['swoosh'] = pygame.mixer.Sound(current_dir + '/../assets/audio/swoosh' + soundExt)
        SOUNDS['wing']   = pygame.mixer.Sound(current_dir + '/../assets/audio/wing' + soundExt)
    except:
        print('音效系统初始化失败！')
